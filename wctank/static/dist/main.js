...
$__System.register('5', ['13', '14'], function (_export) {
     ...
     * This needs to be called before attempting to use any part of this library that needs
     * the audio context, and should only be called if the web audio api exists on the client.
     * @method init
     * @for audio.core
     */

    function init() {
        _export('ctx', ctx = new (window.AudioContext || window.webkitAudioContext)());
        _export('out', out = ctx.createGain());
        out.gain.value = 1;
...
$__System.register("75", ["13", "14", "18"], function (_export) {
    ...
    function webglSetup(canvas, shaders, includeFullscreenVertices, DEBUG) {
        ...
        if (gl) {
            ...
            if (DEBUG) showShaderLog(frag_shader);
...
$__System.register("25", ["5", "7", "8", "9", "10", "18", "19", "32", "34", "35", "37", "56", "75", "d", "e", "b", "1a", "a", "c", "1b", "1c", "f"], function (_export) {
    ...
    return {
        ...
        execute: function () {
            ...
            // add alias to audio/core.init; makes sense?
            init = audioCore.init;
...
$__System.register("7a", ["4", "13", "17", "19", "20", "24", "25", "27", "29", "2a"], function (_export) {
    ...
    function initAllMarkers(callback) {
    ...
    return {
        ...
        execute: function () {
            ...
            _export("initAllMarkers", initAllMarkers);
...
$__System.register("17", ["3", "13", "20", "1d"], function (_export) {
    ...
    function zoomControlsVisible(b) {
        var $zoomCtl = window.$(".gmnoprint").not(".gm-style-cc");
...
$__System.register("1", ["2", "3", "4", "16", "17", "18", "23", "7a", "1f"], function (_export) {

    // initalize google map
    "use strict";

    var audioUI, $, featureDetection, audioScene, gMap, renderLoop, PrintAnalog, markersStart, forceDataUpdate, initAllMarkers, tableux, bounds, overlay, glow, flags, stock_list;
    return {
        setters: [function (_7) {
            audioUI = _7;
        }, function (_) {
        ...
        execute: function () {
            ...
            if (!featureDetection.webaudio) {
                // TODO: create a new batch of fallbacks
