...
System.register("lib/rudy/renderLoop", [], function (_export) {
...
System.register("js/main", ["lib/jquery", "google-maps", "lib/rudy/renderLoop"], function (_export) {
  var $, google, renderLoop;
  return {
    setters: [function (_libJquery) {
      $ = _libJquery["default"];
    }, function (_googleMaps) {
      google = _googleMaps["default"];
    }, function (_libRudyRenderLoop) {
      renderLoop = _libRudyRenderLoop;
    }],
    execute: function () {
      "use strict";
    }
